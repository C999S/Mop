...
token = ("6841697223:AAEBIBiSDaogob7Azb-im5k71D7XLNL2PxU")
os.system('clear')
...
def start(message):
	...
	v = types.InlineKeyboardButton("ᴬᴺᴳᴱᴸ ᴼᶠ ᵀᴴᴱ ᴶᴵᴺᴺ ",url='https://t.me/rffr3')
	mas.add(v)
...
def c2(message):
	...
	⌯ By Telegram : @rffr3''')
				...
				v = types.InlineKeyboardButton("⌯ Developer </>",url='https://t.me/rffr3')
